...
<head>
    <meta charset="utf-8" />
    <title>Change password successfully | Ticketing Sistem</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-4">
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-success text-danger pb-0 fw-bold">Not Found!</h4>
                                <p class="text-muted mb-4">Your email <?php echo $_GET['email'];?> not found.</p>
                            </div>
                        </div> <!-- end card-body -->
                    </div>
                    <!-- end card -->
