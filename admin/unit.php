                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="namaunit" class="mb-1">Department : </label>
                            <input class="form-control" type="text" id="namaunit">
                            <br>
                            <label for="singkatanunit" class="mb-1">Unit : </label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="unit" class="mb-1">Department : </label>
                            ...
                            <br>
                            <label for="sunit" class="mb-1">Unit : </label>
        ...
        <div class="modal fade" id="deleteusers" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5 style="text-align:center;">Kamu Yakin, Ingin Delete Unit Ini ?</h5>
