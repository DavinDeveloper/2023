                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-sm-4">
                                        <a href="javascript:void(0);" class="btn btn-danger mb-2" data-bs-toggle="modal" data-bs-target="#modaldp"><i
                                                class="mdi mdi-plus-circle me-2"></i> Add Department</a>
                                    </div>
                                </div>
                                <table id="datatable-buttons" class="table dt-responsive ">
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <?php echo $fetch['id_department']?>
                                            </td>
                                            <td>
                                                <?php echo $fetch['nama_department']?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php 
                                            echo '<a onclick="updateakses('.$fetch['id_department'].')" class="btn btn-outline-primary mdi mdi-square-edit-outline"></a>&nbsp;
                                            <a onclick="deleteusers('.$fetch['id_department'].')" class="btn btn-outline-danger mdi mdi-delete"></a>
                                            '
                                            ?>
                                            </td>
                                        </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Insert Department</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                    </div> <!-- end modal header -->
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="department" class="mb-1">Department : </label>
                            <input class="form-control" type="text" id="namadepartment">
                        </div>
        ...
        <div class="modal fade" id="deleteusers" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5 style="text-align:center;">Kamu Yakin, Ingin Delete Department Ini ?</h5>
...
<script type="text/javascript">
    function updateakses(id) {
        ...
        $.ajax({
            ...
            cache: false,
            async: true,
            url: "fungsi/cek_department.php",
            success: function (data) {
                var datadepartment = data.nama_department;
    ...
    function aksesupdate() {
        ...
        $.ajax({
            ...
            cache: false,
            async: true,
            url: "fungsi/proses_dpupdate.php",
            success: function (data) {
    ...
    function aksesdelete() {
        ...
        $.post("./fungsi/proses_dpdelete.php", {
                id: id
            },
    ...
    $.ajax({
        ...
        cache: false,
        async: true,
        url: "fungsi/proses_dpinsert.php",
        success: function (data) {
