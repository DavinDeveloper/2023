...
$query_created = "SELECT COUNT(*) FROM tiket WHERE t_assigned = :user_id AND t_status = 'Pending'";
$query_closed = "SELECT COUNT(*) FROM tiket WHERE t_assigned = :user_id AND t_status = 'Closed'";
$query_assigned = "SELECT COUNT(*) FROM tiket WHERE t_assigned = :user_id AND t_status = 'Assigned'";
// Count overdue tickets using date comparison
$query_overdue = "SELECT COUNT(*) FROM tiket WHERE t_assigned = :user_id AND (t_due_date < NOW() AND t_status != 'Closed') OR t_status = 'Overdue'";
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card widget-flat">
                            <div class="card-body">
                                <h5 class="text fw-normal mt-0" style="color:#0000ff;">Pending</h5>
                                <h3 class="mt-2 mb-2">
                                    <?php echo $created_tickets; ?>
                                </h3>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-3">
                        <div class="card widget-flat">
                            <div class="card-body">
                                <h5 class="text fw-normal mt-0" title="Number of Orders" style="color:#00e600;">Closed
                                </h5>
                                <h3 class="mt-2 mb-2">
