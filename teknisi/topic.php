                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-sm-4">
                                        <a href="javascript:void(0);" class="btn btn-danger mb-2" data-bs-toggle="modal" data-bs-target="#modaldp"><i
                                                class="mdi mdi-plus-circle me-2"></i> Add Topic</a>
                                    </div>
                                </div>
                                <table id="datatable-buttons" class="table dt-responsive ">
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <?php echo $fetch['id_topic']?>
                                            </td>
                                            <td>
                                                <?php echo $fetch['nama_topic']?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php 
                                            echo '<a onclick="updateakses('.$fetch['id_topic'].')" class="btn btn-outline-primary mdi mdi-square-edit-outline"></a>&nbsp;
                                            <a onclick="deleteusers('.$fetch['id_topic'].')" class="btn btn-outline-danger mdi mdi-delete"></a>
                                            '
                                            ?>
                                            </td>
                                        </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Insert Topic</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                    </div> <!-- end modal header -->
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="namatopic" class="mb-1">Topic : </label>
                            <input class="form-control" type="text" id="namatopic">
                        </div>
...
<script type="text/javascript">
    function updateakses(id) {
        ...
        $.ajax({
            ...
            cache: false,
            async: true,
            url: "fungsi/cek_topic.php",
            success: function (data) {
                var datatopic = data.nama_topic;
    ...
    function aksesupdate() {
        ...
        $.ajax({
            ...
            cache: false,
            async: true,
            url: "fungsi/proses_tpupdate.php",
            success: function (data) {
    ...
    function aksesdelete() {
        ...
        $.post("./fungsi/proses_tpdelete.php", {
                id: id
            },
    ...
    $.ajax({
        ...
        cache: false,
        async: true,
        url: "fungsi/proses_tpinsert.php",
        success: function (data) {
