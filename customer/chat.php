...
<div class="row">
    <? if (in_array($data_pesanan['status'], array("Diambil","Penjemputan","Perjalanan","Pembayaran"))) { ?>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">Silahkan membuat kesepakatan harga untuk perjalanan healing kamu.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
                        <? } ?>
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
