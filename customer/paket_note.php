...
<div class="alert alert-primary alert-dismissible fade show" role="alert">
  ...
  <hr>
  <p class="mb-0">Harga di atas adalah harga pengantaran paket dari <? echo $data_destinasi['destinasi1']; ?> ke <? echo $data_destinasi['destinasi2']; ?> atau sebaliknya.</p>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>	
<label for="pemberangkatan" class="col-sm-12 col-form-label">Pemberangkatan Paket </label>
