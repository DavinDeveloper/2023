...
<div class="row">
        ...
        if (isset($_POST['pesan'])) {
        	...
        	if (mysqli_num_rows($check_pesanan) > 0 OR mysqli_num_rows($check_customer) > 0) {
        	    ...
        	    $insert = mysqli_query($op, "INSERT INTO pesanan (id_user,id_destinasi_kampus,tipe,kampus,catatan,patokan,harga,pembayaran,latitude_customer,longitude_customer) VALUES ('".$data_user['id']."','$post_destinasi','Pulang','$post_kampus','$post_catatan','$post_patokan','".$data_destinasi['harga'.$post_kampus.'']."','$post_pembayaran','$post_latitude','$post_longitude')");
            	if ($insert == TRUE) {
        ...
        ?>
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Pulang Kampus</h5>
              <form method="POST">
                ...
                <label for="kampus" class="col-sm-12 col-form-label">Dari </label>
                ...
                <div class="row mb-3">
                    <label for="destinasi" class="col-sm-12 col-form-label">Tujuan</label>
                    <select id="destinasi" name="destinasi" class="form-control select2 form-select" required>
                        <option value="">Pilih kampus asal...</option>
                    </select>
                </div>
